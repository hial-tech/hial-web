export const liveLearningLabs = [
  ...
  },
  {
    ...
    description: 'Small description comes here',
    imageUrl: '/hial-web/assets/enterprises/2.png',
    buttonText: 'Learn more'
  },
  {
    id: 'pride-of-ladakh',
    ...
    description: 'Small description comes here',
    imageUrl: '/hial-web/assets/enterprises/3.png',
    buttonText: 'Learn more'
  }
];
...
export const liveLearningLabPageData = {
  title: 'HIAL’s Live learning labs',
  ...
  image: '/hial-web/assets/enterprises/header-1.png',
  detail: {
    title: 'What are our Live learning labs?',
  ...
  sectionTitle: 'Explore our Live learning labs'
};
